...
namespace DoAnBanHang.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult CapNhatThongTin(TaiKhoan check)
        {
            ...
            //TaiKhoan result = db.TaiKhoan.Find(check.ID_TK);

            TaiKhoan result = db.TaiKhoan.Find(check.ID_TK);
            result.Ten = check.GetClone(check);
            ...
            return RedirectToAction("TrangChu","TrangChu"); // sau khi cập nhật quay về trang chủ Index
